...
**Last reviewed:** 2026-07-17 (Week 13 weekly review — added CRISIS-TRACK ENGAGEMENT GATE to Hard Rules per 2-week evidence marker met: Wk 12 IDR Stage 5 THRESHOLD PIERCED + Wk 13 6-consecutive-session Stage 5 CONFIRMED-HARD-ENGAGED persistence + explicit Wk 12 pre-commitment demonstrated to hold cleanly Wk 13 with 45+ SKIP procedural discipline zero discretionary drift; supersedes Wk 12 last-reviewed date)
...
- **CRISIS-TRACK ENGAGEMENT GATE (codified 2026-07-17, Wk 13 — per 2-week evidence marker met: Wk 12 IDR Stage 5 THRESHOLD PIERCED + Wk 13 6-consecutive-session Stage 5 CONFIRMED-HARD-ENGAGED persistence + Wk 13 45+ SKIP procedural discipline demonstration):** When IDR/USD sustained close ≥18,050 for 2+ consecutive sessions, the crisis-track engagement gate ACTIVATES and forbids all new BUY entries regardless of ticker fundamentals or 15-check buy-side gate outcome until ALL FIVE re-entry criteria are met concurrently: (a) IDR sub-17,750 sustained 3-of-3 consecutive sessions; (b) multi-source cluster convergence ≥3-source ≤4% relaxed at candidate entry price (co-canonical Data Quality Gate satisfied); (c) MSCI Info-Flow / S&P DJI 2027 Watchlist accessibility overhang absorbed to neutral or better; (d) foreign-flow inflection re-confirmed 2+ consecutive net-BUY sessions; (e) R:R ≥2:1 achievable at fresh cluster mark. Held positions during gate ACTIVATION continue under standard stop-state discipline (HARD-CUT / TRAILING per stop-logic rules); gate does NOT force close-all-positions (that remains reserved for -15% max drawdown trigger). Gate DE-ACTIVATION requires all five re-entry criteria concurrent; partial satisfaction (e.g., IDR de-armed but foreign-flow still net-sell) keeps gate ACTIVE. Rationale: Wk 12 Stage 5 THRESHOLD PIERCED activation + Wk 13 6-session persistence at 18,050-18,090 band demonstrated that a codified engagement gate produces mechanically consistent SKIP discipline preventing discretionary drift under prolonged binding; the alpha cost is bounded (Wk 13 -3.77pp weekly compression under IHSG +3.77% rally = arithmetic 100%-cash cost) and cumulative alpha remains structurally deep in positive territory (Wk 13 close +16.71pp cumulative from Day 0 baseline).
